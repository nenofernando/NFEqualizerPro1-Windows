...
"en": dict(
    ...
    logo_p="The NF roundel at the top-left identifies the manufacturer. <b>Double-clicking it resets the plugin window to its default size</b> &mdash; handy after dragging the resize corner to make the window larger. The blue dot at the top-right is a status indicator.",
    ...
    about_p="Click the <b>“MONO CHECK” title</b> at the top of the panel to see the plugin's name, version number and manufacturer at a glance.",
    sec_footer_h="Footer",
...
"pt": dict(
    ...
    logo_p="O emblema NF no canto superior esquerdo identifica o fabricante. <b>Dar um duplo clique nele reseta a janela do plugin pro tamanho padr\u00e3o</b> &mdash; \u00fatil depois de arrastar o canto de redimensionar pra deixar a janela maior. O ponto azul no canto superior direito \u00e9 um indicador de status.",
    ...
    about_p="Clique no <b>t\u00edtulo \u201cMONO CHECK\u201d</b> no topo do painel pra ver o nome do plugin, n\u00famero da vers\u00e3o e fabricante rapidamente.",
    sec_footer_h="Rodap\u00e9",
