...
; Installs grouped under "NF Plugins\" per the NF Plugins branding convention
; (see INTEGRACAO.md) so every product in the line lands in the same place.
...
Name "${PRODUCT_NAME}"
OutFile "pro-eq-windows-setup.exe"
InstallDir "$COMMONFILES64\VST3\NF Plugins\${VST3_BUNDLE_NAME}"
