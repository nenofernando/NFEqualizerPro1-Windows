...
harder or gentler. While linked, dragging either knob shows its usual
value bubble plus a matching one over the other knob, so both linked
values stay visible at once. A single click (no drag) on either the
INPUT or OUTPUT knob resets both to 0 dB. Turning Link off frees both
knobs to move independently again.
</div>
...
glance. They also spin faster or slower to match the selected TAPE SPEED —
quickest at 30 IPS, slowest at 7.5 IPS.
</p>
<h3>Tube lamps</h3>
<p>
